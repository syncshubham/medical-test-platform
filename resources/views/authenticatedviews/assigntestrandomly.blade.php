...
<div class="page-wrapper">
    ...
    <div class="row">
    <div class="col">
    <h3 class="page-title">Assign Test Randomly</h3>
    </div>
    </div>
    </div>
...
@endif
    ...
    <div class="card-body">
    <form method="post" action="{{ route('assign.random.test') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group row">
            ...
            <select name="test_id" id="mySelect" style="width: 100%;">
             ...
             <select name="lab_id" id="mySelecttwo" style="width: 100%;">
              ...
              <div class="col-md-10">
                <input type="text" id="lab_rate" name="lab_rate" value="{{ old('lab_rate') }}" class="form-control">
              </div>
              ...
              <div class="col-md-10">
                <input type="text" id="final_rate" name="final_rate" value="{{ old('final_rate') }}" class="form-control">
